  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <text x="1216" y="130" fontFamily="var(--font-mono)" fontSize="14" fill="#fff" opacity="0.85">
          34 MB
        </text>
        {/* secondary pills */}
        ...
        <text x="1164" y="199" fontFamily="var(--font-mono)" fontSize="13" fill="var(--muted)">
          18 MB
        </text>
        <rect x="1040" y="232" width="200" height="52" rx="26" fill="var(--pill)" stroke="var(--line)" />
        <text x="1062" y="265" fontFamily="var(--font-sans)" fontSize="17" fontWeight="600" fill="var(--fg)">
          640×360
        </text>
        <text x="1156" y="265" fontFamily="var(--font-mono)" fontSize="13" fill="var(--muted)">
          6 MB
        </text>
        {/* saved row */}
